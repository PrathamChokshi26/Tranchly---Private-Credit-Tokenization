...
import { ArrowRight, AlertTriangle, CheckCircle2, ArrowLeft, Award, Shield, TrendingUp, Zap, Info, Sparkles } from 'lucide-react';
...
export default function LoanApplication() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6" data-testid="loan-application-page">
      ...
      {/* ─── STEP 3 — RESULTS (V2) ──────────────────────────────── */}
      {step === 3 && cs && (
        <div className="space-y-5" data-testid="step-3-results">
