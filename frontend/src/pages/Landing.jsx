    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-purple-100 text-purple-700 px-3 py-1 rounded-full text-sm font-medium mb-6">
              <Zap size={14} /> Verified small-business cash flows
            </div>
            <h1 className="text-5xl lg:text-6xl font-bold text-gray-900 leading-tight">
              Get funding based on your <span className="bg-gradient-to-r from-purple-600 to-teal-500 bg-clip-text text-transparent">real business cash flow</span> — not just your credit score.
            </h1>
            <p className="mt-6 text-xl text-gray-600 leading-relaxed">
              Apply in minutes. Connect your bank. Get a real credit decision with clear reasons and a path to approval.
            </p>
            <div className="mt-8 flex flex-wrap gap-4">
              <Link to="/signup" className="bg-gradient-to-r from-purple-600 to-purple-700 text-white px-6 py-3 rounded-xl text-base font-semibold hover:from-purple-700 hover:to-purple-800 transition-all shadow-lg shadow-purple-200">
                Apply for a Loan <ArrowRight className="inline ml-2" size={16} />
              </Link>
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-20">
            ...
            <div>
              ...
              <div className="space-y-6">
                {[
                  { step: '01', title: 'Browse Verified Loans', desc: 'Explore vetted SME loans graded A through C with transparent credit scores and target annual returns.' },
                  { step: '02', title: 'Invest from $50', desc: 'Buy fractional loan shares. Each share represents a portion of a real business loan paying interest.' },
                  { step: '03', title: 'Receive Repayment Distributions', desc: 'As borrowers repay, distributions are credited to your account in USDC. Track everything in real-time.' },
                ].map((item, i) => (
            ...
            <div>
              ...
              <div className="space-y-6">
                {[
                  ...
                  { step: '02', title: 'Get Funded by the Crowd', desc: 'Once approved, investors fund loan shares of your loan. No banks, no gatekeepers.' },
                  { step: '03', title: 'Build Your Capital Passport', desc: 'Every on-time repayment builds your verified credit history — your Capital Passport.' },
                ].map((item, i) => (
                  <div key={i} className="flex gap-4">
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl lg:text-4xl font-bold text-gray-900">Ready to access fractional private credit?</h2>
          <p className="mt-4 text-lg text-gray-500">Whether you're growing a business or growing your portfolio.</p>
          ...
          <p className="mt-6 text-xs text-gray-400 max-w-2xl mx-auto">
            Tranchly loan investments are not FDIC insured and may result in loss of principal. Returns are not guaranteed.
      ...
      <footer className="bg-[#0f172a] text-slate-400 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-[11px] mt-4 max-w-3xl leading-relaxed text-slate-500">
            Tranchly loan investments are not FDIC insured and may result in loss of principal. Returns are not guaranteed.
            Past performance does not predict future results. All loans carry risk of default; loan default may result in
